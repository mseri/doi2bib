(* BibTeX Pretty Printer in OCaml using Parser Combinators *)
(* generated by Claude: https://claude.ai/share/6cdc04c1-ca20-4efc-93c2-474438dda8cf *)
...
let quoted_string input pos =
  ...
  | Some (_, pos1) ->
      let rec loop acc pos brace_level =
        ...
        | Some c -> loop (acc ^ String.make 1 c) (pos + 1) brace_level
      in
      loop "" pos1 0
  | None -> None
...
let example_bibtex = {|
% This is a comment
@article{knuth1974,  author = "Donald E. Knuth",title = "Computer Programming as an Art",
  journal = "Communications of the ACM",
  year = 1974,
  volume = 17,number = 12,pages = "667--673"
}
@book{
knuth1997art,  author = "Donald E. Knuth",
  title = {The Art of Computer Programming, Volume 1: Fundamental Algorithms}, publisher = "Addison-Wesley",
  year = 1997,
  edition = "3rd",
  isbn = "0201896834"
}

@mastersthesis{     smith2020,author = "John Smith",
  title = "A Study of Algorithms",school = "MIT",
       year = 2020}
|}

(* Main function to demonstrate the pretty printer *)
let main () =
  Printf.printf "Original BibTeX:\n%s\n\n" example_bibtex;
  Printf.printf "Parsing and pretty-printing...\n\n";

  try
    let parsed_items = parse_bibtex example_bibtex in
    let formatted = pretty_print_bibtex parsed_items in
    Printf.printf "Pretty-printed BibTeX:\n%s\n" formatted;
    Printf.printf "\nParsed %d items\n" (List.length parsed_items)
  with
